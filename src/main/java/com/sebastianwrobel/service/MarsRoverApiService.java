...
import com.sebastianwrobel.repository.PreferencesRepository;
import com.sebastianwrobel.response.MarsPhoto;
import com.sebastianwrobel.response.MarsRoverApiResponse;

@Service
public class MarsRoverApiService {
	
	 private static final String API_KEY = "bwN1JP9VR9hgqJQEdhVLQOC9coy4YhDyH54pZKeC";
